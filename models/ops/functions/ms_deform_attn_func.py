...
def return_sampling_grid_l__core_pytorch(value, value_spatial_shapes, sampling_locations):
    # for debug and test only,
    # need to use cuda version instead
    N_, S_, M_, D_ = value.shape
    #sampling_locations.shape torch.Size([8, 300, 8, 1, 4, 2])
